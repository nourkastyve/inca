...
<body>
    ...
    <nav>
        ...
        <div class="nav">
            ...
            <select>
                <option value="" style="color:transparent;" disabled selected>Diamant</option>
    ...
    <main>
        <div class="cont">
            <form action="" method="post">
                <label for="">réferende :   </label>
                <input type="text" name="reference" id=""><br>
                ...
                <div class="action">
                    <input type="submit" value="enregistrer" class="bou">
                    <input type="reset" value="restaurer" class="bou">
                </div>
            </form>
        </div>
    </main>
